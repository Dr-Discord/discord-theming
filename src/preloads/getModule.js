module.exports = (chunk) => {
  const webpackExports = !chunk.webpackExports ? chunk.push([
    [Symbol("")], {}, (exp) => {
      chunk.pop()
      return exp
    }
  ]) : chunk.webpackExports
  chunk.webpackExports = webpackExports
  return function getModule(filter, first = true) {
    let modules = []
